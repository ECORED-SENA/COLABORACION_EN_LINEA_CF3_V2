...
.curso-main-container.introduccion
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .contenedor.bg--2-claro-2.p-5.mt-5(data-aos="zoom-in-up")
        .avatar: img(src='@/assets/curso/avatar1.png', alt='Imagen decorativa' style='width: 582px')
        .contenedor-img__1: img(src='@/assets/curso/1.png', alt='Imagen decorativa' style='width: 280px')
    ...
    .row.align-items-center.pt-5.mb-4.mb-lg-0
      .col-lg-7(data-aos='fade-right')
        p En este componente se estudiarán los siguientes conceptos:
        ol.lista-ol--cuadro
          li.d-flex
