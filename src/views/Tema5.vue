        ...
        .tarjeta.bg--4-claro.tarjeta-hover1.p-5.h-100
          ...
          .contenido
            ...
            .tarjeta.tarjeta--am.p-4
              p.mb-0 Por este motivo, un perfil de Facebook no es una opción inteligente para empresas que quieren promocionar productos o interactuar con clientes. Usar un perfil para compartir contenido con fines de lucro es en realidad una infracción de las condiciones de servicio de Facebook y se puede eliminar la cuenta.
